...
class SinglyLinkedList{
    ...
    //My Pop solution is ineffective
    /*
    pop(){
        let tailCheck = this.head;
        while(tailCheck.val != null){
            let pretail = tailCheck;
            if(tailCheck.next.next.next == null){
                pretail = tailCheck;
                this.tail = pretail.next;
                this.tail.next = null;
                break;
            }
