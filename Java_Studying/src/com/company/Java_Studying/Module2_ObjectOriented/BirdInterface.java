...
class Parrot extends BirdAbstractInterface implements CanFly { // Parrot is extending from Bird and implementing CanFly
...
class Penguin extends BirdAbstractInterface { // Penguin is a bird so extending from Bird
