...
//Tail factorial will have space complexity of O(1) instead of O(n) like usual recursion
function tailFactorial(x, valueTillNow = 1){
    if(x === 0){
        return valueTillNow  ;
    }
    else{
        return tailFactorial(x-1, valueTillNow*x);
    }
}
...
console.log("Tail Recursion: " + tailFactorial(4));